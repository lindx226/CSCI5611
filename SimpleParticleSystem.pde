...
void update(float dt){
  ...
  for (int i = 0; i < toGen; i++){
    ...
    vel[numParticles] = new Vec2(random(30,90),random(-200,-190)); // i think this is right for step 2?
    numParticles += 1;
  }
  ...
  if (leftPressed && upPressed) obstacleVel = new Vec2(-obstacleSpeed * (1/sqrt(2)),-obstacleSpeed * (1/sqrt(2)));
  if (rightPressed && upPressed) obstacleVel = new Vec2(obstacleSpeed * (1/sqrt(2)),-obstacleSpeed * (1/sqrt(2)));
  if (leftPressed && downPressed) obstacleVel = new Vec2(-obstacleSpeed * (1/sqrt(2)),obstacleSpeed * (1/sqrt(2)));
  if (rightPressed && downPressed) obstacleVel = new Vec2(obstacleSpeed * (1/sqrt(2)),obstacleSpeed * (1/sqrt(2)));
